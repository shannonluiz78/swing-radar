...
<div class="dashboard-container">
    ...
    <div class="highlight-box">
        ...
        <div class="technical-setup">{highlight['technical_setup']}</div>
        
        <button class="btn-chart" id="btn-{highlight['symbol']}" onclick='showChart("chart-{highlight['symbol']}", "btn-{highlight['symbol']}", {highlight_chart_json})'>📊 View Interactive Chart</button>
        <div id="chart-{highlight['symbol']}" class="chart-container"></div>
    </div>

    <div class="section-title">🔍 Top {len(others)} Other Candidates</div>
